...
export function Mulher({type = 'Primary', size = 'md'}: MulherProps ) {
    ...
    return (
        ...
        <path d="M45.3333 26.6667H29.3333C26.4 26.6667 24 24.2667 24 21.3334" stroke={estilo} stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
        <path d="M18.6665 26.6667V33.3334C18.6665 40.6667 24.6665 46.6667 31.9998 46.6667C39.3332 46.6667 45.3332 40.6667 45.3332 33.3334V26.6667" stroke={estilo} stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
        <path d="M22.7998 49.6C25.1998 51.8667 28.3998 53.3334 31.9998 53.3334C35.5998 53.3334 38.7998 51.8667 41.1998 49.6" stroke={estilo} stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
