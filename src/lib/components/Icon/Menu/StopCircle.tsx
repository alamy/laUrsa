...
export function StopCircle({type = 'Primary', size = 'md'}: StopCircleProps ) {
    let estilo = '';
    let width;
    let height;
    ...
    return (
        ...
        <path d="M15 9H9V15H15V9Z" stroke={estilo} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
        </svg>
    );
