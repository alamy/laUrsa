...
export interface ArrobaProps {
    type?: 'Primary' | 'Second';
    size?: 'sm' | 'md' | 'lg' | 'xl';
}

export function Arroba({type = 'Primary', size = 'md'}: ArrobaProps ) {
    let estilo = '';
    let width;
    let height;
